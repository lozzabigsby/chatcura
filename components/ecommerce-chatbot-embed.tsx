...
export default function EcommerceChatbotEmbed() {
  ...
  useEffect(() => {
    ...
    iframe.src = "https://www.chatbase.co/chatbot-iframe/mDNHgWUWdpCirWut-PQIT"
  ...
  return (
    <div ref={chatContainerRef} className="w-full h-[500px] rounded-lg bg-card border border-border">
      <div className="flex items-center justify-center h-full">
        <p className="text-muted-foreground">Loading e-commerce chatbot...</p>
      </div>
    </div>
  )
}
