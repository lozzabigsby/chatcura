...
export default function SalonChatbotEmbed() {
  ...
  useEffect(() => {
    ...
    iframe.src = "https://www.chatbase.co/chatbot-iframe/r57eHrXY-1nhdmRSlcQvn"
  ...
  return (
    <div ref={chatContainerRef} className="w-full h-[500px] rounded-lg bg-card border border-border">
      <div className="flex items-center justify-center h-full">
        <p className="text-muted-foreground">Loading salon chatbot...</p>
      </div>
    </div>
  )
}
