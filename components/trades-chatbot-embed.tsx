...
export default function TradesChatbotEmbed() {
  ...
  useEffect(() => {
    ...
    iframe.src = "https://www.chatbase.co/chatbot-iframe/jl3E1YQm1uS83MzGDIbHJ"
  ...
  return (
    <div ref={chatContainerRef} className="w-full h-[500px] rounded-lg bg-card border border-border">
      <div className="flex items-center justify-center h-full">
        <p className="text-muted-foreground">Loading trades chatbot...</p>
      </div>
    </div>
  )
}
